...
public class WifiIphone {
	...
	void initialize() {
		...
		JLabel lblWifiOnAn = new JLabel("Wifi on an Iphone uses a NetID login");
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(desktop != null && desktop.isSupported(Desktop.Action.BROWSE)) {
					URI eduWebsiteLink = null;
					try {
						eduWebsiteLink = new URI("https://oit.unr.edu/services-and-support/network-and-internet/wireless-access/eduroam/connecting-to-eduroam-on-mobile-devices/connecting-to-eduroam-apple-mobile-devices-ios/");
					}
					catch(URISyntaxException e1) {
						e1.printStackTrace();
					}
