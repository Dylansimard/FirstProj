...
public class BadEmployeeEmailLogin {
	...
	void initialize() {
		...
		//initializing and setting the frame
		frame = new JFrame();
		...
		//button redirect to incognito shortcuts
		JButton btnToIncognito = new JButton("Incognito Shortcuts");
		btnToIncognito.addActionListener(new ActionListener() {
